    ...
    <div>
      ...
      {/* <img className="w-8 h-8 m-3 rounded-full" src="https://cdn.pixabay.com/photo/2017/01/31/21/23/avatar-2027366_960_720.png" alt="avatar"/> */}
        <div class="flex items-end w-3/4">
          <div class="p-3 bg-purple-200 dark:bg-gray-800 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
            ...
            <div class="flex items-start my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2 justify-between">
              <div class="me-2">
